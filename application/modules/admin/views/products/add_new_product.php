        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Tambah Menu</h6>
                </div>
            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="form-control-label" for="date_tour">Tanggal Pesan:</label>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-footer text-right">
                    <input type="submit" value="Tambah Menu Baru" class="btn btn-primary">
                </div>
            </div>
        </div>
    </div>
