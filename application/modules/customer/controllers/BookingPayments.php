...
class BookingPayments extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('bookingpayments/payments', $payments);
    ...
    public function confirm()
    {
        ...
        $this->load->view('header', $params);
        $this->load->view('bookingpayments/confirm', $payments);
        $this->load->view('footer');
    }
    ...
    public function do_confirm()
    {
        ...
        else
        {
            ...
            redirect('customer/BookingPayments/confirm');
        }
    }
    ...
    public function view($id = 0)
    {
        if ( $this->booking->is_order_exist($id))
        {
            ...
            $this->load->view('header', $params);
            $this->load->view('bookingpayments/view', $order);
            $this->load->view('footer');
        }
        else
        {
