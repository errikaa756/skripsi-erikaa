        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary">
                    ...
                    <?php echo form_open_multipart('customer/BookingPayments/do_confirm'); ?>
                    <div class="card-body">
                        <?php if ($flash) : ?>
            ...
            <div class="col-md-4">
                <div class="card card-info">
                    ...
                    <div class="card-body p-0">
                      <?php if ( count($bookings_payments) > 0) : ?>
                        <table class="table table-condensed table-striped">
                          <?php foreach ($bookings_payments as $payment) : ?>
                            <tr>
                                <td>#</td>
                                <td>
                                    <?php echo anchor('customer/BookingPayments/view/'. $payment->order_id, 'Order #'. $payment->order_number); ?>
                                </td>
                                <td>
