        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary">
                    ...
                    <?php echo form_open_multipart('customer/ReservasiMejaPayment/do_confirm'); ?>
                    <div class="card-body">
                        <?php if ($flash) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="order_id" class="form-control" id="orders">
                                <?php foreach ($reservasi as $order) : ?>
                                    <option value="<?php echo $order->id; ?>" <?php echo set_select('order_id', $order->id, ($order_id == $order->id) ? TRUE : FALSE); ?>>#<?php echo $order->order_number; ?> (Rp <?php echo format_rupiah($order->total_dp); ?>)</option>
                                <?php endforeach; ?>
                            </select>
                            <?php else : ?>
            ...
            <div class="col-md-4">
                <div class="card card-info">
                    ...
                    <div class="card-body p-0">
                      <?php if ( count($reservasi_payment) > 0) : ?>
                        <table class="table table-condensed table-striped">
                          <?php foreach ($reservasi_payment as $payment) : ?>
                            <tr>
                                <td>#</td>
                                <td>
                                    <?php echo anchor('customer/ReservasiMejaPayment/view/'. $payment->order_id, 'Order #'. $payment->order_number); ?>
                                </td>
                                <td>
